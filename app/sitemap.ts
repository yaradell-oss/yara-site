...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/programs/taste-of-freedom`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/programs/blooming-garden`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
